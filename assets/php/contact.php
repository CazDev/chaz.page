<?php
    ...
    */
    ...
    $mail->setFrom($email, 'Contact - caz-dev.com'); // Set the sender of the message.
    $mail->addAddress('contact@caz-dev.com', $name); // Set the recipient of the message.
    $mail->Subject = 'Contact - caz-dev.com'; // The subject of the message.
    $mail->body = $message;
